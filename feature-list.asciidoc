...
** https://github.com/oasp/oasp4j/wiki/guide-security[Security]
* Angular
** https://github.com/oasp/oasp4js/[OASP4JS]
** https://github.com/oasp/oasp-tutorial-sources/wiki[Tutorial]
...
** https://www.nuget.org/packages?q=oasp[Nuget packages]
* Node.js
** https://github.com/oasp/oasp4fn/[OASP4FN]
...
* DevOps
** https://github.com/devonfw/devonfw-shop-floor[Devonfw Shop Floor]
